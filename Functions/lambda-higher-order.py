...
displayed with red color for better visibility. The higher-order function apply_operation() applies the selected
operation to the input numbers."""
...
# Higher-order function to apply operation to two numbers
...
def main():
    ...
    title = "Lambda Math Operations with Higher-Order Functions"
    display_title(title)
    ...
    # Perform the selected operation using higher-order functions
    if choice == '1':
        result = apply_operation(add, num1, num2)
        print(Fore.GREEN + f"Result of addition: {result}")
    elif choice == '2':
        result = apply_operation(subtract, num1, num2)
        print(Fore.GREEN + f"Result of subtraction: {result}")
    elif choice == '3':
        result = apply_operation(multiply, num1, num2)
        print(Fore.GREEN + f"Result of multiplication: {result}")
    elif choice == '4':
        if num2 != 0:
            result = apply_operation(divide, num1, num2)
