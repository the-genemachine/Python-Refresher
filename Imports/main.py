...
displayed with red color for better visibility. Functions for mathematical operations are stored in a separate file
named calculator.py, which are imported and used in the main program file main.py. Additionally, cProfile is used to
measure the overall execution time of the main function, and the results are displayed at the end of the program."""
...
def main():
    ...
    title = "Python Imports Demonstration"
    display_title(title)
